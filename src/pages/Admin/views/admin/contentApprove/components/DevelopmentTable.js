...
export default function ManageTable(props) {
  const { columnsData, tableData, liveContentData, upcomingContentData } = props;
  ...
  return (
    <Card
      ...
      <Tabs isFitted variant='enclosed'>
        <TabList mb='1em'>
          <Tab>Live Content</Tab>
          <Tab>Upcoming Content</Tab>
        </TabList>
        <TabPanels>
          <TabPanel>
