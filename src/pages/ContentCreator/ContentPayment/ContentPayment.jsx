    ...
    <>
      ...
      >
                                ...
                                {data.is_pay_approval ? (
                                  ...
                                  <>
                                    ...
                                    <p className="text-danger">
                                      **Your Contents Payment will be approved
                                      by the Admin in 2 to 3 bussiness Days**
                                    </p>
                                  </>
                                )}
                              </div>
        ...
        <div className="mobile-view text-md">
          <h2 className="sponsor-mobile-text">My Contents Payment Status</h2>
                                ...
                                <div>
                                  ...
                                  {data.is_pay_approval ? (
                                    ...
                                    <>
                                      ...
                                      <p className="text-danger">
                                        **Your Payment will be approved by the
                                        Admin in 2 to 3 bussiness Days**
                                      </p>
                                    </>
                                  )}
                                </div>
