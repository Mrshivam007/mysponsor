...
import { deleteContent, fetchContent } from "../../../redux/actions/contentAction";
                                    ...
                                    >
                                                ...
                                                <div className="row mx-0">
                                                    <div className="col-3 p-3">
                                                        <img s src={apiurl + data.thumbnail1}
                                                            alt="" style={{ width: "100%" }} />
                                                    </div>
                                                    ...
                                                    <div className="col-4 p-4">
                                                        <div className="box">
                                                            ...
                                                            <div className="container text-white text-center d-flex justify-content-between px-0 mt-5">
                                                                ...
                                                                <div className="box myevents-box" onClick={() => dispatch(deleteContent(data.content_id))} >
                                                                    <h5 className="pt-1">
                                                                        <img
                                                                            src={info}
                                                                            alt=""
                                ...
                                <div className="col-12">
                                    <div className="card myevents-card">
                                        <div className="post-thumb">
                                            <img src={apiurl + data.thumbnail1} alt="" style={{ width: "100%" }} />
