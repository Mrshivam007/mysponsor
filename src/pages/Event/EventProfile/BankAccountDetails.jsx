...
const BnakAccountDetails = () => {
  ...
  console.log("Create Bank details Response ", createBankDetailResponse?.msg);
  ...
  const [AccountNo, setAccountNo] = useState(
    profileDetails?.sponsorDetails?.business_name || ""
  );
  ...
  const handleSubmitClick = async (e) => {
    ...
    formData.append(
      "account_no",
      profileDetails.bankDetails?.account_no || AccountNo
    );
    formData.append(
      "account_holder_name",
      profileDetails.bankDetails?.account_no || AccountName
    );
    formData.append(
      "ifsc_code",
      profileDetails.bankDetails?.account_no || ifscNo
    );
    try {
      // Make POST API call
                ...
                <div className="row gx-3 mb-3">
                  <div className="col-md-6">
                    ...
                    <input
                      ...
                      value={
                        profileDetails.bankDetails?.account_holder_name ||
                        AccountName
                      }
