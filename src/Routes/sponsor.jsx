  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route
          path="/sponsor_content_payment"
          element={<SponsorContentPayment />}
        />
        <Route path="/about" element={<About />} />
        <Route path="/contact" element={<Contact />} />
        <Route path="/login" element={<Navigate to={"/"} />} />
        <Route
          path="/content_register"
          element={<Navigate to={"/mycontent-details"} />}
        />
        <Route
          path="/event_register"
          element={<Navigate to={"/myevent-details"} />}
        />
        <Route path="/creator-profile" element={<ContentCreatorProfile />} />
